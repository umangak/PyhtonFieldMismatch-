...
{% endif -%}
  month_end_date DATE,
  total_monthly_movement_quantity BIGNUMERIC,
  total_monthly_movement_amount BIGNUMERIC,
  amount_monthly_cumulative BIGNUMERIC,
  quantity_monthly_cumulative BIGNUMERIC)
PARTITION BY
