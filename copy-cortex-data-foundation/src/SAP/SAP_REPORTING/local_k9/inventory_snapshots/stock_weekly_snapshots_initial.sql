...
`{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.stock_weekly_snapshots`(
  ...
  week_end_date DATE,
  total_weekly_movement_quantity BIGNUMERIC,
  total_weekly_movement_amount BIGNUMERIC,
  amount_weekly_cumulative BIGNUMERIC,
  quantity_weekly_cumulative BIGNUMERIC);
